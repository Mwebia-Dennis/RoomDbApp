...
import com.penguinstech.cloud_syncer.controller.FileController;
import com.penguinstech.cloud_syncer.controller.TaskController;
            ...
            firebaseDatabase.child(userName).child(Configs.subscriptionTableName)
                    .child("subscription_details").get().addOnSuccessListener(dataSnapshot -> {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            if((Integer.parseInt(subscription.totalSize) - Integer.parseInt(subscription.coveredSize)) > 0) {
